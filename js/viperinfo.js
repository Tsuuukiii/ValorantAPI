...
function viperinfo(){
    ...
    let agentname = agent11.displayName
    let agentdisc = agent11.description
    let agentablilites = agent11.abilities
    ...
    let bgcolor = agent11.backgroundGradientColors;
    let color1 = bgcolor[0]
    let color2 = bgcolor[1]
    let color3 = bgcolor[2]
    let color4 = bgcolor[3]
    let agentpicture = agent11.fullPortrait
