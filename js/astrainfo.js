...
function astrainfo(){
    ...
    let agentname = agent13.displayName
    let agentdisc = agent13.description
    let agentablilites = agent13.abilities
    ...
    let bgcolor = agent13.backgroundGradientColors;
    let color1 = bgcolor[0]
    let color2 = bgcolor[1]
    let color3 = bgcolor[2]
    let color4 = bgcolor[3]
    let agentpicture = agent13.fullPortrait
