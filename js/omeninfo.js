  ...
  function omeninfo(){
    ...
    let agentname = agent19.displayName
    let agentdisc = agent19.description
    let agentablilites = agent19.abilities
    ...
    let bgcolor = agent19.backgroundGradientColors;
    let color1 = bgcolor[0]
    let color2 = bgcolor[1]
    let color3 = bgcolor[2]
    let color4 = bgcolor[3]
    let agentpicture = agent19.fullPortrait
