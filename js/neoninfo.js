...
function neoninfo(){
    ...
    let agentname = agent15.displayName
    let agentdisc = agent15.description
    let agentablilites = agent15.abilities
    ...
    let bgcolor = agent15.backgroundGradientColors;
    let color1 = bgcolor[0]
    let color2 = bgcolor[1]
    let color3 = bgcolor[2]
    let color4 = bgcolor[3]
    let agentpicture = agent15.fullPortrait
