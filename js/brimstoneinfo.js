...
function brimstoneinfo(){
    ...
    let agentname = agent14.displayName
    let agentdisc = agent14.description
    let agentablilites = agent14.abilities
    ...
    let bgcolor = agent14.backgroundGradientColors;
    let color1 = bgcolor[0]
    let color2 = bgcolor[1]
    let color3 = bgcolor[2]
    let color4 = bgcolor[3]
    let agentpicture = agent14.fullPortrait
