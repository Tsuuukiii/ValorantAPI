...
function harborinfo(){
    ...
    let agentname = agent10.displayName
    let agentdisc = agent10.description
    let agentablilites = agent10.abilities
    ...
    let bgcolor = agent10.backgroundGradientColors;
    let color1 = bgcolor[0]
    let color2 = bgcolor[1]
    let color3 = bgcolor[2]
    let color4 = bgcolor[3]
    let agentpicture = agent10.fullPortrait
