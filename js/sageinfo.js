...
function sageinfo(){
    ...
    let agentname = agent17.displayName
    let agentdisc = agent17.description
    let agentablilites = agent17.abilities
    ...
    let bgcolor = agent17.backgroundGradientColors;
    let color1 = bgcolor[0]
    let color2 = bgcolor[1]
    let color3 = bgcolor[2]
    let color4 = bgcolor[3]
    let agentpicture = agent17.fullPortrait
