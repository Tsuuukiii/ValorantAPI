...
function phoenixinfo(){
    ...
    let agentname = agent12.displayName
    let agentdisc = agent12.description
    let agentablilites = agent12.abilities
    ...
    let bgcolor = agent12.backgroundGradientColors;
    let color1 = bgcolor[0]
    let color2 = bgcolor[1]
    let color3 = bgcolor[2]
    let color4 = bgcolor[3]
    let agentpicture = agent12.fullPortrait
